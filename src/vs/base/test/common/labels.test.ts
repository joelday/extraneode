...
suite('Labels', () => {
	...
	test('template', () => {
		...
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: '', appName: 'Extraneode', separator: { label: ' - ' } }), 'Extraneode');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: 'Untitled-1', rootName: '', appName: 'Extraneode', separator: { label: ' - ' } }), 'Untitled-1 - Extraneode');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: 'monaco', appName: 'Extraneode', separator: { label: ' - ' } }), 'monaco - Extraneode');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: 'somefile.txt', rootName: 'monaco', appName: 'Extraneode', separator: { label: ' - ' } }), 'somefile.txt - monaco - Extraneode');
		assert.strictEqual(labels.template(t, { dirty: '* ', activeEditorShort: 'somefile.txt', rootName: 'monaco', appName: 'Extraneode', separator: { label: ' - ' } }), '* somefile.txt - monaco - Extraneode');

		// real world example (other)
		t = '${dirty}${activeEditorShort}${separator}${rootNameShort}${separator}${appName}';
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: 'monaco (Workspace)', rootNameShort: 'monaco', appName: 'Extraneode', separator: { label: ' - ' } }), 'monaco - Extraneode');
	});
