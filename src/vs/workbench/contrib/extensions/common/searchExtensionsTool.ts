...
export const SearchExtensionsToolData: IToolData = {
	...
	modelDescription: localize('searchExtensionsTool.modelDescription', "This is a tool for browsing Extraneode Extensions Marketplace. It allows the model to search for extensions and retrieve detailed information about them. The model should use this tool whenever it needs to discover extensions or resolve information about known ones. To use the tool, the model has to provide the category of the extensions, relevant search keywords, or known extension IDs. Note that search results may include false positives, so reviewing and filtering is recommended."),
	userDescription: localize('searchExtensionsTool.userDescription', 'Search for extensions in the Extraneode Extensions Marketplace'),
