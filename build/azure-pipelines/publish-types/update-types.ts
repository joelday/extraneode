...
function getNewFileHeader(tag: string) {
	...
	const header = [
		`// Type definitions for Extraneode ${shorttag}`,
		`// Project: https://github.com/microsoft/vscode`,
		`// Definitions by: Extraneode Team, Microsoft <https://github.com/microsoft>`,
		...
		``,
		`/**`,
		` * Type Definition for Extraneode ${shorttag} Extension API`,
